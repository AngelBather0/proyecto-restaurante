    ...
    <div class="max-w-screen-2xl w-full mx-auto px-4 sm:px-6 lg:px-8 px-4 sm:px-6 lg:px-8 mt-12">
        ...
        <div class="bg-white rounded-md max-w-[65%] mx-auto">
            <div class="flex justify-between px-6 py-4 border-b border-gray-200">
                <h4 class="text-lg font-normal text-gray-900">Detalles de Guia</h4>
                <!-- Enlace para editar -->
                <a href="{{ route('guides.edit', $guia->GuiaID) }}" class="text-yellow-500 hover:text-yellow-700 font-bold py-2 px-4 rounded">
            ...
            <div class="p-6 px-0 grid grid-cols-1 fieldsContainer">
                <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                    <center><b><p>El guia seleccionado no existe, o hubo un error al mostrarlo.</p></b></center>
                </div>
            </div>
            @else
                <div class="p-6 px-0 grid grid-cols-1 fieldsContainer">

                    <!-- Campo Nombre del guia -->
                    <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                        <label class="text-[16px] font-medium leading-thing mr-2 flex items-center w-[250px]" for="name">Nombre</label>
                        <div class="w-full">
                            <span class="border border-gray-200 px-4 py-[8px] box-border rounded text-md">{{$guia->Nombre}}</span>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                        ...
                        <div class="w-full">
                            <span class="border border-gray-200 px-4 py-[8px] box-border rounded text-md">{{$guia->lugar->Nombre}}</span>
                        </div>
                    </div>

                    <!-- Campo Telefono de guia -->
                    <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                        <label class="text-[16px] font-medium leading-thing mr-2 flex items-center w-[250px]" for="Telefono">Telefono</label>
                        <div class="w-full">
                            <span class="border border-gray-200 px-4 py-[8px] box-border rounded text-md">{{$guia->Telefono}}</span>
                        </div>
                    </div>

                    <!-- Campo Idiomas de guia -->
                    <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                        <label class="text-[16px] font-medium leading-thing mr-2 flex items-center w-[250px]" for="Idiomas">Idiomas</label>
                        <div class="w-full">
                            <span class="border border-gray-200 px-4 py-[8px] box-border rounded text-md">{{$guia->Idiomas}}</span>
                        </div>
                    </div>

                    <!-- Campo Experiencia -->
                    <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                        <label class="text-[16px] font-medium leading-thing mr-2 flex items-center w-[250px]" for="descripcion">Experiencia</label>
                        <div class="w-full">
                            <div class="border border-gray-200 px-4 py-[8px] box-border rounded text-md">
                                {!! nl2br(e($guia->Experiencias)) !!}
                            </div>
                        </div>
                    </div>
