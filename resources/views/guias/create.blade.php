        ...
        <form action="{{ route('guides.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="bg-white rounded-md max-w-[65%] mx-auto">
                ...
                <div class="px-6 py-4 border-b border-gray-200">
                    <h4 class="text-lg font-normal text-gray-900">Agregar Guia Turistico</h4>
                </div>
                ...
                <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                    ...
                    <div class="w-full">
                        <input type="text" required name="Telefono" value="{{ old('Telefono') }}" class="w-full border border-gray-200 px-4 py-[8px] box-border rounded text-md">
                    </div>
                </div>

                <div class="flex justify-between px-12 py-8 border-b border-gray-200">
                    <label class="text-[16px] font-medium leading-thing mr-2 flex items-center w-[250px]" for="Experiencias">Experiencias</label>
                    <div class="w-full">
                        <textarea name="Experiencias" id="experiencias" cols="30" rows="4" class="w-full min-h-[80px] border border-gray-200 px-4 py-[8px] box-border rounded text-md" required>{{ old('Experiencias') }}</textarea>
                    </div>
                </div>
