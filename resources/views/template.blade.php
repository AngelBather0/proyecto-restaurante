      ...
      -->
        ...
        <div class="hidden lg:flex lg:w-64 lg:flex-col lg:fixed lg:inset-y-0">
            ...
            <div class="flex flex-col flex-grow bg-mundoVerdeGreen pt-5 pb-4 overflow-y-auto">
                <a href="/dashboard">
                    <div class="flex items-center ml-10 flex-shrink-0 mb-6 text-5xl text-white italic bold">
                        <h1>Restfolio</h1>
                    </div>
                </a>
                ...
                <li class="products pl-10 hover:bg-gradient-to-r from-gray-600 navLink mb-2">
                    ...
                    Productos
                            ...
                            <a href="{{ route('users.index') }}"
                                class="guias navLink -mr-2 rounded-r-none hover:bg-gradient-to-r from-gray-600 text-white group flex items-center pl-6 py-2 text-lg !mb-2 box-border w-full leading-6 font-normal" aria-current="page">
                                <!-- Heroicon name: outline/home -->
                                <img class="h-23px mr-4" src="{{ url('/images/white-settings.png') }}" alt="">
                                Gestionar usuarios
                            </a>
                            @endrole
                            

                            {{-- <a href="#" class="-mr-2 rounded-r-none hover:bg-gradient-to-r from-green-800 text-white group flex items-center pl-6 py-2 text-lg !mb-2 box-border w-full leading-6 font-normal" aria-current="page">
                <!-- Heroicon name: outline/home -->
                <img class="h-23px mr-4" src="{{url('/images/computer.png')}}" alt="">
                Sumary
                </a> --}}
                        ...
                        <div class="h-60px bg-white flex-1 items-center flex justify-between p-4 py-3 rounded-2xl invisible">
                            ...
                            <div class="flex items-center ml-auto mr-auto">
                              ...
                              @foreach($languages as $code => $name)
                                  <a href="{{ route('cambiar-idioma', ['locale' => $code]) }}">
                                      <button type="button" class="px-4 py-2 rounded text-sm mr-4 hover:bg-gray-300 duration-300">{{ $name }}</button>
                                  </a>
                              @endforeach
                            </div>
                        </div>
